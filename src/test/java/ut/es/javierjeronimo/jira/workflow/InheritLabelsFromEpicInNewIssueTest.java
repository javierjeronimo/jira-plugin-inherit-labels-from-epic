package ut.es.javierjeronimo.jira.workflow;

import es.javierjeronimo.jira.workflow.InheritLabelsFromEpicInNewIssue;
...
public class InheritLabelsFromEpicInNewIssueTest
{
    public static final String MESSAGE = "my message";

    protected InheritLabelsFromEpicInNewIssue function;
    ...
    public void setup() {
        ...
        function = new InheritLabelsFromEpicInNewIssue() {
