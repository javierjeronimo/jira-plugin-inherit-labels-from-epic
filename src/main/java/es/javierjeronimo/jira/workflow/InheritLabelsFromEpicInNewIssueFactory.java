package es.javierjeronimo.jira.workflow;
...
public class InheritLabelsFromEpicInNewIssueFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory
{
    public static final String FIELD_MESSAGE = "messageField";

    private WorkflowManager workflowManager;

    public InheritLabelsFromEpicInNewIssueFactory(WorkflowManager workflowManager) {
